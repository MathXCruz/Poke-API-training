...
That PokeAPI extraction function is written in a way that allows access to any endpoint of the API. \
Currently, the code extracts data about a user input Pokemon and prints out a summary of its main characteristics, along with a link to its sprite. \
